...
manage_new_operators( _ConstructPairs=[ { Arity, FunInfo } | T ], FunctionTable,
	...
	NewFunInfo = case FunInfo#function_info.exported of
		...
		[] ->
			% Never exported, so exporting it at the standard location (the
			% actual export form will be automatically generated by Myriad when
			% recomposing the final AST):
			%
			FunInfo#function_info{ exported=[ ExportLoc ] };

		_ ->
			% Already exported at least once, hence good to go:
			FunInfo
...
add_v3_operators( Classname, Arity, ExportLocation, DefinitionLoc, IsDebugMode,
	...
	S3 = get_local_receive( Classname, IsDebugMode, Line ),
...
add_v4_operators( Classname, Arity, ExportLocation, DefinitionLoc, _IsDebugMode,
	...
	ConstructParamTypes = [ NodeType
							| get_construction_types( ArgArity, Line ) ],
...
add_v7_operators( Classname, Arity, ExportLocation, DefinitionLoc, IsDebugMode,
	...
	S3 = get_remote_receive( Classname, IsDebugMode, Line ),
...
% end
%
-spec get_local_receive( basic_utils:module_name(), time_utils:time_out(), line() ) ->
						 form_element().
get_local_receive( ModuleName, IsDebugMode, Line ) ->
...
% end
%
-spec get_remote_receive( basic_utils:module_name(), time_utils:time_out(), line() ) ->
						 form_element().
get_remote_receive( ModuleName, IsDebugMode, Line ) ->
